...
form.addEventListener('submit', (e) => {
  ...
  if(repeat_password_input){
    // If we have a repeat password input then we are in the signup
    errors = getSignupFormErrors(firstname_input.value, password_input.value, repeat_password_input.value)
  }
  else{
    // If we don't have a repeat password input then we are in the login
